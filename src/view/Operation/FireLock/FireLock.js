        ...
        return <div className="list-item " key={index}>
            ...
            <div className="col">
                <Button type="primary" onClick={() => {
                    history("/FireLockView", {state: item.lockAddr})
                }}>
                    View
                </Button>
            </div>
                    ...
                    <div className="header-box">
                        ...
                        <div className="search-container">
                            <form className="search-box">
                                <Input placeholder="Search Lock Contract Addess" allowClear value={searchData} onChange={handleSearchChange}/>
