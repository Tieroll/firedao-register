...
const FireLock = (props) => {
    ...
    const approve = async () => {
        ...
        /*eslint-disable*/
        await handleDealCoinMethod("approve", form.getFieldValue().TokenAddress.toString().trim(), [address, BigInt(10 ** 50).toString()])
    ...
    const lock = async () => {
        ...
        if (coinInfo.decimal && parseInt(coinInfo.decimal) > 0) {
            ...
            /*eslint-disable*/
            coinAmount = BigInt(amount * FireLockDecimal).toString()
        ...
        if (ownerType == 2) {
            ...
            handleDealMethod2("Lock", address, [TokenAddress.toString().trim(), admin, UnlockCycle, UnlockRound, coinAmount,
                ...
                <div className="panel-container">
                    ...
                    <Form form={form} name="control-hooks">
                        <Form.Item
                            ...
                            validateFirst={true}
                            rules={[
                                {required: true, message: 'Please input Lock Contract Address!'},
                                {
                ...
                <div className="panel-container">
                    ...
                    <Form form={form} name="control-hooks">
                        ...
                        <div className="input-box">
                            ...
                            <Tooltip
                                title="Cliff Period: full lockdown period, during which unlock is not allowed; nobody including administrators is allowed to withdraw tokens during the lockdown.">
                        ...
                        <div className="input-box">
                            ...
                            <Tooltip
                                title="Unlock Cycle：unlock frequency, which means how soon you are allowed to unlock. ">
                                <QuestionCircleOutlined className="icon"/>
                            </Tooltip>
                            <div className="tip">
                                Days
                        ...
                        <div className="input-box">
                            ...
                            <Tooltip
                                title="Unlock Round：the amount of rounds until being fully unlocked">
                                <QuestionCircleOutlined className="icon"/>
                            </Tooltip>
                        ...
                        {endTime && (
                            <div className="input-box">
                                ...
                                <Tooltip
                                    title="Example: on March 11,2023, we set cliff period as 1 day, unlock period 2 days and the
                                unlock cycle 2 rounds, then the unlock will begin on March 12,2023, complete within 4
                                days and be end time on March 16,2023.">
                                    <QuestionCircleOutlined className="icon"/>
                                </Tooltip>
                    ...
                    <div className="panel-container">
                        ...
                        <div>
                            <div className="mint-fee">
                                <div className="name">Minting Fee:</div>
                                <div className="value">{fee / FireLockDecimal}eth</div>
                            </div>
                            {(allowance <= 0) && <Button type="primary" className="sub-btn" onClick={() => {
                                approve()
                            }}>Approve</Button>
                            }
                            {allowance > 10 && <Button type="primary" className="sub-btn" onClick={() => {
                                lock()
                            }}>Submit</Button>}
